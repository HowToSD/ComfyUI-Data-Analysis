...
from pandas_wrapper.pandas_eq_scalar_float import PandasEqScalarFloat

class TestPandasEqScalarFloat(unittest.TestCase):
    def setUp(self):
        """Set up test data."""
        self.node = PandasEqScalarFloat()
        self.test_cases = [
