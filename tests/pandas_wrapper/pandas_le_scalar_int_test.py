...
from pandas_wrapper.pandas_le_scalar_int import PandasLeScalarInt

class TestPandasLeScalarInt(unittest.TestCase):
    def setUp(self):
        """Set up test data."""
        self.node = PandasLeScalarInt()
        self.test_cases = [
            ...
            (
                pd.DataFrame({1: [10.0, 25]}, index=[0, 1]),
                25,
