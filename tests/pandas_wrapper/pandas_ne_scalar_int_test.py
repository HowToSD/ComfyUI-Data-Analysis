...
from pandas_wrapper.pandas_ne_scalar_int import PandasNeScalarInt

class TestPandasNeScalarFloat(unittest.TestCase):
    def setUp(self):
        """Set up test data."""
        self.node = PandasNeScalarInt()
        self.test_cases = [
